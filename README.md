...
## 2. Data and environnement configuration

You need to create a .env file to specify the bucket and file path for the data.

with some informations as MY_BUCKET, CHEMIN_FICHIER, CHEMIN_PARQUET
## 3. Quickstart
